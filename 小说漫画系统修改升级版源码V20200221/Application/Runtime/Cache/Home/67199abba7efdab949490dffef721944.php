...
<head>
    <title><?php echo ($_CFG['site']['name']); ?>_好看的漫画大全网</title>
    ...
    <!-- 共用引入资源.结束 -->
    <script type="text/javascript" src="/Public/home/mhjs/jquery.lazyload.js"></script>
...
<div id="banner-container">
    ...
    <div class="indexnav portal-slick mt-navbar">
        <?php if(is_array($_banner['config'])): $i = 0; $__LIST__ = $_banner['config'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="item">
				<a href="<?php echo U('Mh/bookinfo');?>&mhid=<?php echo ($vo["url"]); ?>">
...
<div class="bm-box mt-10">
	<div class="head">
		<div class="title dot">大家都在看</div>
		<div class="pull-right">
			<a href="<?php echo U('Mh/book_hot');?>">
	...
	<div class="books-row">
		<?php if(is_array($rq)): $i = 0; $__LIST__ = $rq;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="item">
				<a href="<?php echo U('Mh/bookinfo');?>&mhid=<?php echo ($vo["id"]); ?>">
					<img class="lazy" src="<?php echo ($vo["cover_pic"]); ?>" data-original="<?php echo ($vo["cover_pic"]); ?>" style="width:110px;height:146px;" onerror="this.src='<?php echo ($vo["detail_pic"]); ?>'"onerror="this.src='/Public/images/nocover.jpg'"/>
...
<div class="bm-box mt-10">
	<div class="head">
		<div class="title dot">精选推荐</div>
		<div class="pull-right">
			<a href="<?php echo U('Mh/book_recomm');?>">
				更多 <svg width="7" height="12" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14 24">
				<title>right-arrow</title>
				<path d="M1.91 1.93L12.06 12 1.91 22" fill="none" stroke="#ff5420" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/></svg>
			</a>
	...
	<div class="books-row">
		<?php if(is_array($jx)): $i = 0; $__LIST__ = $jx;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="item">
				<a href="<?php echo U('Mh/bookinfo');?>&mhid=<?php echo ($vo["id"]); ?>">
					<img class="lazy" src="<?php echo ($vo["cover_pic"]); ?>" data-original="<?php echo ($vo["cover_pic"]); ?>" style="width:110px;height:146px;" onerror="this.src='<?php echo ($vo["detail_pic"]); ?>'" onerror="this.src='/Public/images/nocover.jpg'"/>
					<div class="title"><?php echo ($vo["title"]); ?></div>
					<div class="text">更新至<?php echo ($vo["episodes"]); ?>话</div>
...
<?php if($mf): ?><div class="bm-box mt-10">
	...
	<div class="books-row">
		<?php if(is_array($mf)): $i = 0; $__LIST__ = $mf;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div style="width:100%;padding-bottom: 20px;border-bottom: 1px solid #ddd;position:relative;">
				<img src="<?php echo ($vo["cover_pic"]); ?>" data-original="<?php echo ($vo["cover_pic"]); ?>" style="width:88px;height:110px;float:left;margin:10px;" onerror="this.src='<?php echo ($vo["detail_pic"]); ?>'"/>
				...
				<div class="text" style="margin-top: 5px;font-size: 14px;color: #666666;height:60px;text-overflow: ellipsis;overflow: hidden; word-wrap: break-word;word-break: break-all;"><?php echo ($vo["summary"]); ?></div>
   ...
   <a href="<?php echo U('Mh/book_free');?>">
	<div  style="width: 80%;height: 60px;text-align: center;line-height:60px;background-color: #3e82c8;margin: 10px auto;border-radius: 15px;font-size: 15px;">
 ...
 <div style="margin:10px 0;width:100%;border:1px solid #eeeeee"></div>	 
    <div class="indexnav portal-slick mt-navbar" >
			<div class="item">
				...
				<img class="slide_loading" src="/Public/images/vip.png" alt="vip图片" style="height: 150px;"/>
				</a>
			</div>
    </div>
	<div style="margin:10px 0;width:100%;border:1px solid #eeeeee"></div>	
