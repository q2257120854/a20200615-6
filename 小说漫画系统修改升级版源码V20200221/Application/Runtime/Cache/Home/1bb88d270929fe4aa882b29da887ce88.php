...
<title><?php echo ($jiinfo["title"]); ?>_<?php echo ($mhinfo['title']); ?>_<?php echo ($_CFG['site']['name']); ?></title>
<meta name="keywords" content="<?php echo ($mhinfo['title']); ?>漫画,<?php echo ($mhinfo['title']); ?>全集,<?php echo ($binfo['title']); ?>漫画全集,<?php echo ($jiinfo["title"]); ?>,动漫,漫画,在线漫画阅读">
<meta name="description" content="《<?php echo ($mhinfo['title']); ?>》《<?php echo ($jiinfo["title"]); ?>》在线阅读，漫画《<?php echo ($mhinfo['title']); ?>》简介：<?php echo ($mhinfo['summary']); ?>">
...
<div class="rt-bar" style="position: absolute">
    <div class="row">
        ...
        <div class="col title"><?php echo ($jiinfo["title"]); ?></div>
        <div class="col link">
...
<article class="read-article">
  <a href="<?php echo U('Mh/pay');?>">
	<div  style="width: 100%;height: 60px;text-align: center;line-height:60px;background-color: #5cc83e;margin: 10px auto;border-radius: 15px;font-size: 15px;">
      <span style="color: white;">资源加载会有点慢，请加载完后再观看，体验更佳！</span>
     </div>	
	<div  style="width: 100%;height: 60px;text-align: center;line-height:60px;background-color: #5cc83e;margin: 10px auto;border-radius: 15px;font-size: 12px;">
      <span style="color: white;">推荐在WIFI环境下浏览，升级VIP可免广告观看！！！【点击升级】</span>
     </div>
    </a>
  <p><dr/></p>
<!--顶部广告代码开始-->
<?php if($user['vip']): else: ?>
<script id='mob' type='text/javascript' charset='utf-8' src='http://kv.xhrxb.com/h.php?pid=1904'></script>
<!--<div id="d1">
    <div class="c1">111
    </div>
    <div class="c1">222
...
<?php if($user['vip']): else: ?>
  <a href="<?php echo U('Mh/pay');?>">
	<div  style="width: 90%;height: 60px;text-align: center;line-height:60px;background-color: #ff0000;margin: 15px auto;border-radius: 15px;font-size: 15px;">
      <span style="color: white;">升级VIP可免广告观看！！！【点击升级】</span>
     </div>	
    </a><?php endif; ?>
<!--底部漂浮广告代码开始-->
<?php if($user['vip']): else: ?>
<script id='mob' type='text/javascript' charset='utf-8' src='http://kv.xhrxb.com/d.php?pid=1904'></script><?php endif; ?>
<!--底部漂浮广告代码结束-->

<!--小图标漂浮广告代码开始-->
<?php if($user['vip']): else: ?>
<script id='mob' type='text/javascript' charset='utf-8' src='http://kv.xhrxb.com/x.php?pid=1904'></script><?php endif; ?>
<!--小图标漂浮广告代码结束-->
<style>
	...
	.picpos .ctn{background: #fff;width: 60%;position: fixed;bottom: 20%;left: 20%;border-radius: 10px;height: 50%;}
...
<div class="picpos">
	...
	<div class="ctn">
	<a href="<?php echo ($_ads["url"]); ?>" >
		<img src="<?php echo ($adsPic); ?>" />
		<img  class="close" src="/Public/images/vip.png" onclick="$('.picpos').hide();" />
	</a>
	</div>
</div>
<!--弹窗广告-->
