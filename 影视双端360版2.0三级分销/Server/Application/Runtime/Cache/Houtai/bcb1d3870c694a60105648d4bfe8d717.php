 ...
 <div class="stystems_style">
  <div class="tabbable">
	<ul class="nav nav-tabs" id="myTab">
	  <li class="active">
		<a data-toggle="tab" href="#home"><i class="green fa fa-home bigger-110"></i>&nbsp;修改公告</a></li>
     
	</ul>
	<form class="am-form am-form-horizontal" action="update" method="POST" enctype="multipart/form-data">
    ...
    <div class="tab-content">
		<div id="home" class="tab-pane active">
         ...
         <div class="form-group"><label class="col-sm-1 control-label no-padding-right" for="form-field-1"><i>*</i>公告内容 </label>
          <div class="col-sm-9"><input type="text" placeholder="请输入公告内容" name="neirong" value="<?php echo ($mod["neirong"]); ?>" class="col-xs-10 "></div>
          </div>
       
		
		  
          <div class="Button_operation"> 
					<button  class="btn btn-primary radius" type="submit"><i class="fa fa-save "></i>&nbsp;修改</button>
