 ...
 <div class="stystems_style">
  <div class="tabbable">
	<ul class="nav nav-tabs" id="myTab">
	  <li class="active">
		<a data-toggle="tab" href="#home"><i class="green fa fa-home bigger-110"></i>&nbsp;支付设置</a></li>
    ...
    <div class="tab-content">
		<div id="home" class="tab-pane active">
         <div class="form-group"><label class="col-sm-1 control-label no-padding-right" for="form-field-1"><i>*</i>商户号 </label>
          <div class="col-sm-9"><input type="text" name="payh" value="<?php echo ($mod["payh"]); ?>" placeholder="商户号" class="col-xs-10 "></div>
          </div>
          <div class="form-group"><label class="col-sm-1 control-label no-padding-right" for="form-field-1"><i>*</i>商户KEY </label>
          <div class="col-sm-9"><input type="text" id="website-title" name="payk" value="<?php echo ($mod["payk"]); ?>" placeholder="商户KEY" class="col-xs-10 "></div>
          </div>
         <div class="form-group"><label class="col-sm-1 control-label no-padding-right" for="form-field-1"><i>*</i>网关类型 </label>
          <div class="col-sm-9"><input type="text" id="website-title" name="payt" value="<?php echo ($mod["payt"]); ?>" placeholder="网关类型例如：http / https" class="col-xs-10 "></div>
          </div>
		<div class="form-group"><label class="col-sm-1 control-label no-padding-right" for="form-field-1"><i>*</i>支付网关 </label>
          <div class="col-sm-9"><input type="text" id="website-title" name="payu" value="<?php echo ($mod["payu"]); ?>" placeholder="支付网关" class="col-xs-10 "></div>
          </div>
