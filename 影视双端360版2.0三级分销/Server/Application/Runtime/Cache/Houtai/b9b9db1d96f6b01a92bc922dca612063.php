...
<title><?php echo ($config); ?>后台系统登录</title>
</head>
...
<div class="login-container">
	<div class="center">
	     <!-- <img src="/Public/admin/images/logo1.png" /> -->
							</div>
								...
								<div id="login-box" class="login-box widget-box no-border visible">
									<div class="widget-body">
										<div class="widget-main">
											...
											<form class="am-form" action="/Houtai/Public/checkLogin/" method="POST">
												<fieldset>
										<ul>
   <li class="frame_style form_error"><label class="user_icon"></label><input type="text"  name="name"  required lay-verify="required" autocomplete="off" class="layui-input"><i>用户名</i></li>
   <li class="frame_style form_error"><label class="password_icon"></label><input type="password" name="pass" required lay-verify="required"  autocomplete="off" class="layui-input"><i>密码</i></li>
