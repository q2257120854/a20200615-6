...
class YouniController extends Controller {
	...
	public function xiaobian(){
		$player ='https://www.360kan.com/dianshi/index.html';
		//$tvinfo = file_get_contents($player);
      	//防止超时
        set_time_limit(0);  
        //初始化一个cURL会话
        ...
        curl_setopt($ch,CURLOPT_REFERER,$player);
        //能保存cookie
        ...
        //设置要请求的url
        curl_setopt($ch, CURLOPT_URL,$player);
        //执行请求并获取放回数据  
        $tvinfo = curl_exec($ch); 
		...
		$totalLink=count($lianjie);
		//var_dump($totalLink);
		$lianjie1=$lianjie[2][0];
		$lianjie2=$lianjie[2][1];
		$lianjie3=$lianjie[2][2];
		$lianjie4=$lianjie[2][3];
		$lianjie5=$lianjie[2][4];
		$lianjie6=$lianjie[2][5];
		$list=array();
		for ($x=1; $x<=$totalLink; $x++) {
			$vv=$x-1;
			$list=
	...
	public function dlun(){
		$player ='https://www.360kan.com/dianying/index.html';
		//$tvinfo = file_get_contents($player);
      	//防止超时
        set_time_limit(0);  
        //初始化一个cURL会话
...
preg_match_all($t, $tvarr[0][0], $lianjie);
	...
	public function zzheng(){
		$player ='https://www.360kan.com/zongyi/index.html';
		//$tvinfo = file_get_contents($player);
      	//防止超时
        set_time_limit(0);  
        //初始化一个cURL会话
        ...
        //执行请求并获取放回数据  
        $tvinfo = curl_exec($ch); 
		$tvzz = '#<div class="content-left p-content-tuijian" data-block="tj-重磅推荐" monitor-desc="重磅推荐" monitor-shortpv>[\s\S]+?<div class="content-right" data-block="tj-排行榜" monitor-desc="排行榜" monitor-shortpv>#';
		preg_match_all($tvzz, $tvinfo, $tvarr);
		...
		for ($x=1; $x<=$totalLink; $x++) {
			...
			array("lianjie"=>$lianjie1,"pic"=>$lianjie[4][0],"title"=>$lianjie[5][0],"biao"=>$lianjie[1][0],"tag"=>$lianjie[6][0]),
			array("lianjie"=>$lianjie2,"pic"=>$lianjie[4][1],"title"=>$lianjie[5][1],"biao"=>$lianjie[1][1],"tag"=>$lianjie[6][1]),
			array("lianjie"=>$lianjie3,"pic"=>$lianjie[4][2],"title"=>$lianjie[5][2],"biao"=>$lianjie[1][2],"tag"=>$lianjie[6][2]),
			array("lianjie"=>$lianjie4,"pic"=>$lianjie[4][3],"title"=>$lianjie[5][3],"biao"=>$lianjie[1][3],"tag"=>$lianjie[6][3]),
			array("lianjie"=>$lianjie5,"pic"=>$lianjie[4][4],"title"=>$lianjie[5][4],"biao"=>$lianjie[1][4],"tag"=>$lianjie[6][4]),
			array("lianjie"=>$lianjie6,"pic"=>$lianjie[4][5],"title"=>$lianjie[5][5],"biao"=>$lianjie[1][5],"tag"=>$lianjie[6][5]),
...
preg_match_all($t, $tvarr[0][0], $lianjie);
	...
	public function drebo(){
		$player ='https://www.360kan.com/dongman/index.html';
		//$tvinfo = file_get_contents($player);
      	//防止超时
        set_time_limit(0);  
        //初始化一个cURL会话
		...
		$lianjie5=$lianjie[2][4];
		$lianjie6=$lianjie[2][5];
		$lianjie7=$lianjie[2][6];
		$lianjie8=$lianjie[2][7];
		$list=array();
		for ($x=1; $x<=$totalLink; $x++) {
			$vv=$x-1;
			$list=
