				...
				<div id="page-content" class="clearfix">
					...
					<div class="row-fluid">
						<!--PAGE CONTENT BEGINS HERE-->
							<form class="form-horizontal" name="addAnnounce"  action="<?php echo U(GROUP_NAME.'/Info/editAnnounceHandle');?>" method="post">
								...
								<div class="control-group">
									<label class="control-label" for="tid"> 信息类别</label>

									<div class="controls">
										<select name="tid">
											<?php if(is_array($type)): foreach($type as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>" <?php if($ann['announcetype']['name'] == $v['name']): ?>selected="selected"<?php endif; ?>><?php echo ($v["name"]); ?></option><?php endforeach; endif; ?>
										</select>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" readonly="readonly" value="<?php echo ($ann["operator"]); ?>" name="operator" id="operator" />
									</div>
								</div>
								<div class="control-group">
									<label class="control-label" for="viewer"> 查看权限</label>

									<div class="controls">

										<input type="radio" value="all" <?php if($ann['viewer'] == 'all'): ?>checked="checked"<?php endif; ?> name="viewer">
										<span class="lbl"> 所有</span>

										<input type="radio" <?php if($ann['viewer'] == 'member'): ?>checked="checked"<?php endif; ?> value="member" name="viewer">
										<span class="lbl"> 会员</span>

										<input type="radio" <?php if($ann['viewer'] == 'center'): ?>checked="checked"<?php endif; ?> value="center" name="viewer">
										<span class="lbl"> 报单中心</span>
								
									</div>
								</div>
								<div class="control-group">
									<label class="control-label" for="content"> 信息内容</label>

									<div class="controls">
										<textarea name="content" style="width:700px; height:300px"><?php echo ($ann["content"]); ?></textarea>
									</div>
								</div>
								<input type="hidden" name="aid" value="<?php echo ($ann["id"]); ?>">
