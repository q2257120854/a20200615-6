				...
				<div id="page-content" class="clearfix">
                       <div class="page-header position-relative">
						   <div style="text-align:left;width:100%;">
						    <a type="button" href="<?php echo U(GROUP_NAME.'/Shop/add_shopbanner');?>" class="btn btn-info btn-small no-border"> <i class="icon-plus icon-white"></i>添加商城滚动图</a>
						    </div>
					   </div>
					<div class="row-fluid">
						...
						<div class="row-fluid">
							<table id="table_report" class="table table-striped table-bordered table-hover">
								...
								<tbody>
                                    <?php if(is_array($shopbanner)): foreach($shopbanner as $key=>$v): ?><tbody> 
										<tr>
                                            <td class="hidden-480"><?php echo ($v["id"]); ?></td>
                                            <td class="hidden-480"><?php echo ($v["sort"]); ?></td>
                                         
                                            <td class="hidden-480">
											
												<img src="<?php echo ($v["path"]); ?>" width="200" height="200">
											</td>
            
                                            <td>
											<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                                            
																<a class="red" onclick="return confirm('你确定要删除吗')" href="<?php echo U(GROUP_NAME .'/Shop/delshopbanner',array('id'=>$v['id']));?>">
