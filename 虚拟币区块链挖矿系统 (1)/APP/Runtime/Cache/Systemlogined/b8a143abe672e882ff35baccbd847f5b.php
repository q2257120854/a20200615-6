				...
				<div id="page-content" class="clearfix">
                       <div class="page-header position-relative">
						   <div style="text-align:left;width:100%;">
						    <a type="button" href="<?php echo U(GROUP_NAME.'/Shop/add_type');?>" class="btn btn-info btn-small no-border"> <i class="icon-plus icon-white"></i>添加分类</a>
						    </div>
					   </div>
					<div class="row-fluid">
								...
								<tbody>
												<?php if(is_array($types)): foreach($types as $key=>$type): ?><tr>
														...
														<td>
															...
															<?php if($type["pid"] == 0): ?><img src="/public/images/1.gif">
															<?php else: ?>
																<img src="/public/images/2.gif"><?php endif; ?>
															
														</td>
														<td><?php echo ($type["id"]); ?></td>
														<td class="hidden-480"><?php echo ($type["name"]); ?></td>
														<?php if($type["pid"] == 0): ?><td>
														
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																	<a class="purple" href="<?php echo U(GROUP_NAME .'/Shop/addSon',array('id'=>$type['id']));?>">
																	<i class="icon-plus bigger-130">添加子版块</i>
																</a>

																<a class="green" href="<?php echo U(GROUP_NAME .'/Shop/editType',array('id'=>$type['id']));?>">
																	<i class="icon-pencil bigger-130">修改</i>
																	
																</a>
                                                               <?php if($type['son'] == '0'): ?><a class="red" onclick="return confirm('你确认要删除吗')" href="<?php echo U(GROUP_NAME .'/Shop/delType',array('id'=>$type['id']));?>">
														...
														<?php else: ?>
															...
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                                                ...
                                                                <?php if($type['video'] == '0'): ?><a class="red" onclick="return confirm('你确定要删除吗')" href="<?php echo U(GROUP_NAME.'/Shop/delType',array('id'=>$type['id']));?>">
																	<i class="icon-trash bigger-130">删除</i>
																</a><?php endif; ?>
															</div>
														</td><?php endif; ?>
