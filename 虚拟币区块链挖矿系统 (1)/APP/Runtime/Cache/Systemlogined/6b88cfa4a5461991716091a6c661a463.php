							...
							<table id="table_report" class="table table-striped table-bordered table-hover">
								...
								<tbody>
									<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
                                            ...
                                            <td><?php echo ($v["tjjnum"]); ?></td>											
                                            <td><?php echo ($v["teamnum"]); ?></td>											
                                            <td><?php echo ($v["teamsuanli"]); ?></td>											
                                            <td><?php echo ($v["mysuanli"]); ?></td>											
                                            <td><?php echo ($v["csbl"]); ?></td>											
                                            <td><?php echo ($v["shouxu"]); ?></td>											
											<td>
												<a href="<?php echo U(GROUP_NAME .'/Member/editMemberGroup',array('groupid'=>$v['groupid']));?>">查看修改</a>      </td>
