...
<script type="text/javascript">
			...
			<div id="main-content" class="clearfix">
				...
				<div id="page-content" class="clearfix">
					...
					<div class="row-fluid">
						...
						<form id="table-searchbar" method="POST" action="<?php echo U(GROUP_NAME.'/jinbidetail/paylist');?>" class="form-inline well well-small">
							...
							<table id="table_report" class="table table-striped table-bordered table-hover">
								...
								<tbody>
									<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
											...
											<td><?php echo ($v["fkzh"]); ?></td>
											<td>
												<?php if($v["status"] == 0): ?>待支付
											...
											<td>
                                               ...
                                               <?php if($v["status"] == 0): ?><a href="javascript:;" status="1" class="shenhe" r_id ="<?php echo ($v["r_id"]); ?>" >同意</a>
                                                <a href="javascript:;" status="2" class="shenhe" r_id ="<?php echo ($v["r_id"]); ?>">拒绝</a>
                                                <?php else: ?>
                                                	--<?php endif; ?>
                                             </td>	
	...
	$(".shenhe").click(function(){
			...
			$.ajax({
				url:"<?php echo U(GROUP_NAME.'/jinbidetail/editPaypost');?>",
				type:'POST',
