				...
				<div id="page-content" class="clearfix">
					<div class="page-header position-relative">
						<div style="text-align:left;width:100%;">
						    <a type="button" href="<?php echo U(GROUP_NAME.'/Info/addAnnounce');?>" class="btn btn-small btn-info no-border"> <i class="icon-plus icon-white"></i> 发布公告</a>
						</div>
					</div><!--/.page-header-->
							...
							<table id="table_report" class="table table-striped table-bordered table-hover">
								<thead>
									<tr>
										...
										<th>发布人</th>
										<th class="hidden-480">
											<i class="icon-time hidden-phone"></i>添加时间</th>
								...
								<tbody>
									<?php if(is_array($ann)): foreach($ann as $key=>$v): ?><tr>
											<td class="center"><?php echo ($v["id"]); ?></td>
											<td><?php echo ($v["title"]); ?></td>
											<td><?php echo ($v["operator"]); ?></td>
											<td class="hidden-480"><?php echo (date('Y-m-d H:i',$v["addtime"])); ?></td>
											<td class="hidden-phone"><?php echo (date('Y-m-d H:i',$v["edittime"])); ?></td>

											<td class="hidden-480"><?php echo ($v["announcetype"]["name"]); ?>
											</td>
											<td>
												<?php switch($v["viewer"]): case "all": ?>所有<?php break;?>
												    <?php case "center": ?>报单中心<?php break;?>
												    <?php case "member": ?>会员<?php break; endswitch;?>
											</td>
											<td class="td-actions">
												<div class="hidden-phone visible-desktop btn-group">

													<button aid="<?php echo ($v["id"]); ?>" class="btn btn-mini btn-info">
