...
<div style="width: 90%;margin-left: 5%;margin-top: 20px;overflow:hidden;border-radius:5px">
    ...
    <p id="chushoubg"onclick='showhidediv("chushou")'style="float: left;width: 25%;text-align: center;background-color: #ff7387;height: 30px;line-height: 30px;color:#fff">我的卖出</p>
    <p id="zzjybg" onclick='showhidediv("zzjy")'style="float: left;width: 25%;text-align: center;background-color: #ff7387;;height: 30px;line-height: 30px;color:#fff">正在交易</p>
    <p id="ywcjybg" onclick='showhidediv("ywcjy")'style="float: left;width: 25%;text-align: center;background-color: #ff7387;;height: 30px;line-height: 30px;color:#fff">历史记录</p>
</div>
<div id="qiugou" style="-left: 5%;margin-bottom:80px;margin-top:30px">
	...
	<?php if(is_array($list)): foreach($list as $key=>$v): ?><ul class="myjy_body"style="width:100%;margin-left:0%;margin-top:10px">
            ...
            <li style="width: 20%;"><a href="<?php echo U('Emoney/delqiugou',array('id'=>$v['id']));?>" style="width: 90%;margin-left: 5%;display: block;height: 30px;line-height: 30px;text-align: center;background-color: #ff7387;border-radius: 5px;color: #FFFFFF">取消</a></li>
            <li style="width: 20%;">
                <?php if($v["zt"] == 0): ?><a href="#" style="width: 90%;margin-left: 5%;display: block;height: 30px;line-height: 30px;text-align: center;background-color: #ff7387;border-radius: 5px;color: #FFFFFF">未交易</a><?php endif; ?>
                <?php if($v["zt"] == 1): ?><a href="#" style="width: 90%;margin-left: 5%;display: block;height: 30px;line-height: 30px;text-align: center;background-color: #ff7387;border-radius: 5px;color: #FFFFFF">交易中</a><?php endif; ?>
                <?php if($v["zt"] == 2): ?><a href="#" style="width: 90%;margin-left: 5%;display: block;height: 30px;line-height: 30px;text-align: center;background-color: #ff7387;border-radius: 5px;color: #FFFFFF">交易完成</a><?php endif; ?>
            </li>
...
<div id="chushou" style="-left: 5%;margin-bottom:80px;margin-top:30px;display: none;width: 90%; margin-left: 5%;">
    ...
    <div>
        <?php if(is_array($cslkb)): foreach($cslkb as $key=>$v): ?><ul class="myjy_body"style="width:100%;margin-left:0%;margin-top:10px">
                ...
                <li style="width: 15%;"><?php echo ($v["lkb"]); ?></li>
                <li style="width: 15%;" class="money"><?php echo ($v["jb"]); ?></li>
                <li style="width: 20%;"><a href="<?php echo U('Emoney/del',array('id'=>$v['id']));?>" style="width: 90%;margin-left: 5%;display: block;height: 30px;line-height: 30px;text-align: center;background-color: #ff7387;border-radius: 5px;color: #FFFFFF">取消</a></li>
                <li style="width: 20%;">
                    <?php if($v["zt"] == 0): ?><a href="#" style="width: 90%;margin-left: 5%;display: block;height: 30px;line-height: 30px;text-align: center;background-color: #ff7387;border-radius: 5px;color: #FFFFFF">未交易</a><?php endif; ?>
                    <?php if($v["zt"] == 1): ?><a href="#" style="width: 90%;margin-left: 5%;display: block;height: 30px;line-height: 30px;text-align: center;background-color: #ff7387;border-radius: 5px;color: #FFFFFF">交易中</a><?php endif; ?>
                    <?php if($v["zt"] == 2): ?><a href="#" style="width: 90%;margin-left: 5%;display: block;height: 30px;line-height: 30px;text-align: center;background-color: #ff7387;border-radius: 5px;color: #FFFFFF">交易完成</a><?php endif; ?>
...
<div id="zzjy" style="display:none;margin-bottom:80px;">
 ...
 if($v['datatype']=='qglkb'){ ?>
                    ...
                    <?php if($v["p_user"] == $_SESSION['username']): ?><li style="position: relative;">
                   	 <div class="pic_show single">
                                    ...
                                    <input  type="file" style=" opacity:0;filter:alpha(opacity=80);cursor:pointer;" name="photoimg" class="upfile" id="upfileid_<?php echo ($v["id"]); ?>"  jtype="qglkb"/>
                                     ...
                                     <?php else: ?>
                                     <!--<button type="button" name="IconPath"  id="photo_other"style="font-size:14px; width: 95%;height: 30px;border:0px;border-radius: 5px;background-color: #ff7387;display: block;line-height: 30px;color: #000000;">已经上传</button>-->
                                     
                                      <button type="button" name="IconPath" class="upload_one<?php echo ($v["id"]); ?> fl" onclick="document.getElementById('upfileid_<?php echo ($v["id"]); ?>').click()" id="photo_other"style="font-size:14px; width: 95%;height: 30px;border:0px;border-radius: 5px;background-color: #ff7387;display: block;line-height: 30px;color: #000000;">已经上传</button>
                    ...
                    <?php if($v["g_user"] == $_SESSION['username']): ?><li><input type="button" class="ckpicture" value="查看图片" data-pic="请输入图片地址" style="font-size:14px; width: 95%;height: 30px;border:0px;border-radius: 5px;background-color: #ff7387;display: block;line-height: 30px;color: #000000;  -webkit-appearance: none;"/></li><?php endif; ?>
                    <?php if($v["p_user"] == $_SESSION['username']): ?><li class="bl2"<a><button class="btnmaijia"style=" width: 95%;height: 30px;border:0px;border-radius: 5px;background-color: #ff7387;display: block;line-height: 30px;color: #000000;font-size:14px;">对方信息</button></a></li><?php endif; ?>
                    <?php if($v["g_user"] == $_SESSION['username']): ?><li class="bl2"><a><button class="btnmai"style=" width: 100%;height: 30px;border:0px;border-radius: 5px;background-color: #ff7387;display: block;line-height: 30px;color: #000000;font-size:14px;">对方信息</button></a></li><?php endif; ?>
                    <?php if($ts == 0): ?><li class="bl2">
                     <button class="btntoushu"style=" width: 95%;height: 30px;border:0px;border-radius: 5px;background-color: #ff7387;display: block;line-height: 30px;color: #000000;font-size:14px;">投诉<input class="tsid" type="hidden" value="1"/></button>
                    </li><?php endif; ?>
                    
                    <?php if($v["p_user"] == $_SESSION['username']): ?><li class="bl3" style="background-color:#ff7387"><a href="#" class="quxiao" style="background-color:#ff7387">取消交易</a></li><?php endif; ?>
                    
                    
                    <?php if($v["g_user"] == $_SESSION['username']): ?><li class="bl3" style="background-color:#ff7387"><a href="#" class="wancheng" style="background-color:#ff7387">完成交易</a></li><?php endif; ?>
 ...
 if($v['datatype']=='cslkb'){ ?>
                ...
                <?php if($v["p_user"] == $_SESSION['username']): ?><li><input type="button" class="ckpicture" value="查看图片" data-pic="请输入图片地址" style="font-size:14px; width: 95%;height: 30px;border:0px;border-radius: 5px;background-color: #ff7387;display: block;line-height: 30px;color: #000000;  -webkit-appearance: none;"/></li><?php endif; ?>   
                
                <?php if($v["g_user"] == $_SESSION['username']): ?><li class="bl2"<a><button class="btnmai"style=" width: 95%;height: 30px;border:0px;border-radius: 5px;background-color: #ff7387;display: block;line-height: 30px;color: #000000;font-size:14px;">对方信息</button></a></li><?php endif; ?> 	
                <?php if($v["p_user"] == $_SESSION['username']): ?><li class="bl2"><a><button class="btnmaijia"style=" width: 100%;height: 30px;border:0px;border-radius: 5px;background-color: #ff7387;display: block;line-height: 30px;color: #000000;font-size:14px;">对方信息</button></a></li><?php endif; ?> 	
                    
                    <li class="bl2">
                     <button class="btntoushu"style=" width: 95%;height: 30px;border:0px;border-radius: 5px;background-color: #ff7387;display: block;line-height: 30px;color: #000000;font-size:14px;">投诉<input class="tsid" type="hidden" value="1"/></button>
                    </li>
                
                <?php if($v["g_user"] == $_SESSION['username']): ?><li class="bl3" style="background-color:#ff7387"><a href="#" class="csquxiao" style="background-color:#ff7387">取消</a></li><?php endif; ?>
                
                <?php if($v["p_user"] == $_SESSION['username']): ?><li class="bl3" style="background-color:#ff7387"><a href="#" class="cswancheng" style="background-color:#ff7387">完成交易</a></li><?php endif; ?>
...
<script>
     function showhidediv(id) {
        ...
        if (id == "zzjy") {
            ...
            qiugoubg.style.backgroundColor = "#ff7387"
			qiugoubg.style.color = "#fff"
            chushoubg.style.backgroundColor = "#ff7387"
            chushoubg.style.color = "#fff"
            zhengzaibg.style.backgroundColor = "#fff";
			zhengzaibg.style.color = "#000";
            wancehngbg.style.backgroundColor = "#ff7387";
            ...
            qiugoubg.style.backgroundColor = "#ff7387";
            zhengzaibg.style.backgroundColor = "#ff7387";
            wancehngbg.style.backgroundColor = "#ff7387";
            qiugoubg.style.color= "#fff"
