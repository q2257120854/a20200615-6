...
<div style="text-align:center;padding-bottom:80px">	
   ...
   <p style="margin:5px 0px;"> <span class="" onclick="jsCopy()" style="cursor:pointer; padding:5px 10px; color:#FFFFFF; background: #ff7387; border-radius:4px; width:80%; display:inline-block; margin:0 auto;">复制</span></p>
