...
<body>
	...
	<form action="" method="POST" style="font-size:14px" id="myform1">
		<ul style="width: 80%;margin-left: 10%;color: #000;padding-top:100px" >
			...
			<input type="button"  class="btn_submit_my" value="确认修改" idtype="myform1" style="width: 100%;height: 30px;line-height: 30px;border-radius: 5px;border: 0px; background-color:#ff7387;margin-top: 5px;color: #FFFFFF;-webkit-appearance: none;"/></li>
		</ul>
	</form>
	...
	<form action="" method="POST" style="font-size:14px;margin-bottom:40px;" id="myform2">
		<ul style="width: 80%;margin-left: 10%;color: #000;padding-top:20px" >
			...
			<input type="button" class="btn_submit_my" value="确认修改" idtype="myform2" style="width: 100%;height: 30px;line-height: 30px;border-radius: 5px;border: 0px; background-color:#ff7387;margin-top: 5px;color: #FFFFFF;-webkit-appearance: none;"/></li>
		</ul>
	</form>
	
	<div style="text-align:right; width:80%; margin:0 auto;"><a href="<?php echo U('Index/Login/editPwd2');?>"><input type="button" value="交易密码找回>>" style="padding:5px 10px; background:#ff7387; color:#ffffff; border-radius:4px; border:0px;"></a></div>
</div>
