...
if(isset($_GET['kw'])) {
	...
	$gls=$DB->count("SELECT count(*) from auth_site WHERE addid = ".$udata['uid']."");
	$sql=" 1";
	$con='您授权的域名共有 <b>'.$gls.'</b> 个域名';
}
...
echo $con;
?>
<div class="panel-heading font-bold">您的授权列表</div>
<div class="panel-body">
      <div class="table-responsive">
        <table class="table table-striped">
          ...
          <tbody>
<?php
$rs=$DB->query("SELECT * FROM auth_site WHERE addid = ".$udata['uid']." order by id desc limit $pageu,$pagesize");
...
if ($page>1)
{
echo '<li><a href="sqlist.php?page='.$first.$link.'">首页</a></li>';
echo '<li><a href="sqlist.php?page='.$prev.$link.'">&laquo;</a></li>';
} else {
echo '<li class="disabled"><a>首页</a></li>';
echo '<li class="disabled"><a>&laquo;</a></li>';
}
for ($i=1;$i<$page;$i++)
echo '<li><a href="sqlist.php?page='.$i.$link.'">'.$i .'</a></li>';
...
if ($page<$s)
{
echo '<li><a href="sqlist.php?page='.$next.$link.'">&raquo;</a></li>';
echo '<li><a href="sqlist.php?page='.$last.$link.'">尾页</a></li>';
} else {
