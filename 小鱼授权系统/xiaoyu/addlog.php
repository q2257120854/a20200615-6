...
$sl=$DB->count("SELECT count(*) from zcd_log WHERE type = 1");
?>
...
echo '<div class="panel-heading font-bold">授权记录列表-共'.$sl.'</div>
<div class="panel-body">
      <div class="table-responsive">
        <table class="table table-striped">
          <thead><tr><th>域名</th><th>添加者ID</th><th>时间</th><th>操作</th></tr></thead>
          <tbody>';
		  //循环写出信息
