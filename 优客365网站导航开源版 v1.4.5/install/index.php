...
<?php require('include/header.php'); ?>
  ...
  <div class="wrap">
    <div class="todo">
      <label><span class="round">2</span><span>授权协议</span></label><i class="triangle-right-bg"></i><i class="triangle-right"></i>
    </div>
  </div>
  <div class="wrap">
    <div class="todo">
...
<div class="right">
<div class="right_title">安装检测</div>
...
<?php }?>
				...
				<form action="agreement.php" style="text-align:center">
         		<input hidefocus="true" type="submit" value="下一步" 	"  
         		<?php if(!$flag){  
