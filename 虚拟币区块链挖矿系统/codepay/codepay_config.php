...
define('DB_PWD', '%Aj7&jbf^7l&123');//数据库密码
define('DB_NAME', 'zhifu');  //数据库名称
 ...
 *
 */
define('DB_USERTABLE', 'member');  //充值用户所在数据库表名
define('DB_USERMONEY', 'baozhengjin');  //充值用户所在表中的金额字段名
define('DB_USERNAME', 'id');  //充值用户名的字段名 根据用户名转换为id
