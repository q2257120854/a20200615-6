				...
				<div id="page-content" class="clearfix">
                       <div class="page-header position-relative">
						   <div style="text-align:left;width:100%;">
						    <a type="button" href="<?php echo U(GROUP_NAME.'/Shop/add_banner');?>" class="btn btn-info btn-small no-border"> <i class="icon-plus icon-white"></i>添加横幅</a>
						    </div>
					   </div>
					<div class="row-fluid">
						...
						<div class="row-fluid">
							<table id="table_report" class="table table-striped table-bordered table-hover">
								...
								<tbody>
                                    <?php if(is_array($banner)): foreach($banner as $key=>$v): ?><tbody> 
										<tr>
											...
											<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																...
																<a class="red" onclick="return confirm('你确定要删除吗')" href="<?php echo U(GROUP_NAME .'/Shop/delbanner',array('id'=>$v['id']));?>">
