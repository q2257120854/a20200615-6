						...
						<!--PAGE CONTENT BEGINS HERE-->
							...
							<input type="hidden"  name="id" value="<?php echo ($product["id"]); ?>">
								<div class="control-group">
									<label class="control-label" for="title"> 矿机名称</label>
								...
								<div class="control-group">
									<label class="control-label" for="gonglv"> 算力</label>

									<div class="controls">
										<input type="text" value="<?php echo ($product["gonglv"]); ?>" name="gonglv" id="gonglv" placeholder="" />
									</div>
								</div>	
								<div class="control-group">
									<label class="control-label" for="yszq"> 运行周期</label>

									<div class="controls">
										<input type="text" value="<?php echo ($product["yszq"]); ?>" name="yszq" id="yszq" placeholder="" />
									</div>
								</div>	
								<div class="control-group">
                                 ...
                                 <div class="control-group">
									<label class="control-label" for="xianshou"> 限制出售数量</label>

									<div class="controls">
										<input type="text" value="<?php echo ($product["xianshou"]); ?>" name="xianshou" id="xianshou" placeholder="" />
									</div>
								</div>	
