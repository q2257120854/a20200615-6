                        ...
                        <div class="tabbable">
                            ...
                            <div class="tab-content">
                                <div id="home" class="tab-pane in active">
                                    <form class="form-horizontal" action="<?php echo U(GROUP_NAME.'/Shai/gonggaoxg');?>" method="post">

                                        <div class="control-group">
                                            <label class="control-label" for="yxgg">游戏公告</label>

                                            <div class="controls">
                                                <input type="text" id="yxgg" name="yxgg" value="<?php echo ($config["yxgg"]); ?>" style=" width: 550px;" class="span3"/>
                                            </div>
                                        </div>
