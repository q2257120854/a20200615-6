	...
	$(function() {
				...
				<div id="page-content" class="clearfix">
					...
					<div class="row-fluid">
						<!--PAGE CONTENT BEGINS HERE-->
							<form class="form-horizontal" name="addProductHandle"  enctype="multipart/form-data" action="<?php echo U(GROUP_NAME .'/Shop/addbanner');?>" method="post">
								<div class="control-group">
									<label class="control-label" for="id"> ID号</label>

									<div class="controls">
										<input type="text" value="" name="id" id="id" placeholder="" />
									</div>
								</div>	
								<div class="control-group">
									<label class="control-label" for="sort"> 顺序号</label>

									<div class="controls">
										<input type="text" value="" name="sort" id="sort" placeholder="" />
									</div>
								</div>		
								<div class="control-group">
									<label class="control-label" for="path"> 缩略图</label>

									<div class="controls">
										 <input type="file" name="path"> 缩略图大小：300*250 
									</div> 
								</div>
		...
		$('form[name="banner"]').validate({
					...
					messages:{
						...
						stock:{required:'顺序不能为空',min:'顺序不能小于等于0'}		
					}
