...
<html lang="en">
	...
	<div class="main-content">
		<div class="breadcrumbs" id="breadcrumbs">
			...
			<ul class="breadcrumb">
				...
				<li>
					<a href="/admin.php/admin/goodsup">上架商品</a>
				</li>
	...
	<div class="main-container">
		<div class="col-xs-9">
			<form class="form-horizontal" role="form" action="/admin.php/Admin/Goodsup/updategoods" method="post" enctype="multipart/form-data">
				<!-- 商品编号 -->
