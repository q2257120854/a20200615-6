...
<html lang="en">
	...
	<div class="main-content">
		...
		<div class="page-content">
			...
			<div class="page-header">
				<h1>
					商品发布
					<a href="/admin.php/admin/Goodsup" class="btn btn-info btn-sm pull-right">
	...
	<div class="main-container">
		<div class="col-xs-9">
			<form class="form-horizontal" role="form" action="/admin.php/Admin/Goodsissue/insertGd" method="post" enctype="multipart/form-data">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="col-xs-10 col-sm-5" placeholder="请输入商品价格" name="goldprice">
					</div>
				</div>
				<div class="form-group">
	...
	<script type="text/javascript">
		jQuery(function($) {
			...
			$('#selparent').on('change','select',function(){
				...
				$.ajax({
					url:"/admin.php/admin/goodsclass/viewclassid",
					type:'post',
					...
					success:function(data){
						...
						if (!datas.length) {
							...
							// ajax请求商品的属性
							$.ajax({
								url:"/admin.php/admin/Goodsissue/goodsAttr",
								type:'post',
								data:{cid:goodattrid},
								dataType:'json',
								success:function(data){
							...
							// ajax请求商品的品牌
							$.ajax({
								url:'/admin.php/admin/Goodsissue/goodsBrand',
								type:'post',
								data:{cid:goodattrid},
								dataType:'json',
								success:function(data){
		...
		//1 设置ueditor目录
		window.UEDITOR_HOME_URL = "/Public/admin/js/ueditor/";
	</script>
	<!-- 加载配置文件 2-->
