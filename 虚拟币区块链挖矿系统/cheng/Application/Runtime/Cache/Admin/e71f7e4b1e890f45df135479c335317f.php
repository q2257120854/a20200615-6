...
<html lang="en">
				...
				<div class="col-xs-12">
					...
					<div class="row" style="padding:0px;height:auto;overflow:hidden;margin-bottom:10px;">
						...
						<div class="col-xs-12 col-sm-4">
							<form action="/admin.php/Admin/Goodsup/search" method="get">
								...
								<?php if(is_array($goodupdata)): foreach($goodupdata as $key=>$vo): ?><tr>
										...
										<td>
											<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
												<a class="blue" name="down_<?php echo ($vo["gid"]); ?>" data-toggle="modal" href="#myModal">
													<i class="icon-download bigger-130"></i>
												</a>
												<a class="green" href="/admin.php/Admin/Goodsup/modgoods/gid/<?php echo ($vo["gid"]); ?>">
	...
	<script type="text/javascript">
		jQuery(function($) {
			//设置当前页面的菜单高亮显示 开始
			var nownav = "#sidebar a[href*=Goodsup]";
			...
			$('#delete-data').on('click',function(){
				$.ajax({
					url:"/admin.php/Admin/Goodsup/delgoods",
					type:"get",
					data:{gid:delid},
					// 执行成功执行以下函数，返回值为data
			...
			$('#down-goods').on('click',function(){
				$.ajax({
					url:"/admin.php/Admin/Goodsup/downgoods",
					type:"get",
					data:{gid:downid},
					// 执行成功执行以下函数，返回值为data
					success:function(data){
