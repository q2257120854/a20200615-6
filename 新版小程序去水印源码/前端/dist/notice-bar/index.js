Component({
    ...
    methods: {
        initAnimation: function() {
            var t = this;
            wx.createSelectorQuery().in(this).select(".i-noticebar-content-wrap").boundingClientRect(function(i) {
                wx.createSelectorQuery().in(t).select(".i-noticebar-content").boundingClientRect(function(a) {
