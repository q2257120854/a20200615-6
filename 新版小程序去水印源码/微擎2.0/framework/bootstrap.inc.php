...
if(!file_exists($configfile)) {
	if(file_exists(IA_ROOT . '/install.php')) {
		...
		echo "&nbsp;&nbsp;<a href='http://www.yunziyuan.com.cn' style='font-size:12px' target='_blank'>Power by 5G云源码分享网 " . IMS_VERSION . " &nbsp;点击获得更多微擎微赞商业源码</a>";
		exit();
	} else {
		header('Content-Type: text/html; charset=utf-8');
...
if ($_W['config']['setting']['development'] == 2) {
	...
	if (class_exists('Raven_Autoloader')) {
		...
		$client = new Raven_Client('http://8d52c70dbbed4133b72e3b8916663ae3:0d84397f72204bf1a3f721edf9c782e1@qq.com/6');
