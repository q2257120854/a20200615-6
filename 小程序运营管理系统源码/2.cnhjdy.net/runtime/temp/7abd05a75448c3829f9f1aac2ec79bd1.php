...
<input type="hidden" id="nowhtml" value="navSystem" class="navSystem7">

	<ul class="breadcrumb">
		<li>
			<i class="icon-home"></i>
			版权管理--<?php echo $applet['name']; ?>
		</li>
	</ul>
...
<!-- 					<a href="<?php echo Url('Copyright/demo'); ?>?appletid=<?php echo $_GET['appletid']?>" >
					...
					<form action="<?php echo Url('Copyright/savemail'); ?>?appletid=<?php echo $_GET['appletid']?>" id="form_sample_2" class="form-horizontal" method="post" enctype="multipart/form-data" onsubmit = "return checkinfo();">
						

						<div class="control-group chongdingy">
							<label class="control-label chongdingywz">邮箱配置</label>
						</div>

						
						<div class="control-group chongdingy">
							<label class="chongdingywz" style="margin-bottom:0;">发件箱请使用“个人QQ邮箱”，<a href="http://service.mail.qq.com/cgi-bin/help?subtype=1&&no=1001256&&id=28"  target="_blank">点击此处查看授权码获取教程</a></label>
						</div>
						...
						<div class="control-group">
							...
							<div class="controls">
								...
								<input name="mail_user" type="text" class="span3 m-wrap"  style="height: 35px !important;" value="<?php if($forminfo && $forminfo['mail_user']): ?><?php echo $forminfo['mail_user']; endif; ?>" />
						...
						<div class="control-group">
							...
							<div class="controls">
								...
								<input name="mail_password" type="text" class="span3 m-wrap"  style="height: 35px !important;" value="<?php if($forminfo && $forminfo['mail_password']): ?><?php echo $forminfo['mail_password']; endif; ?>"/>
								<span style="color:#999999; line-height:40px; margin-left:20px;"><a href="http://service.mail.qq.com/cgi-bin/help?subtype=1&&no=1001256&&id=28" target="_blank">点击此处查看授权码获取教程</a></span>
							</div>
						...
						<div class="control-group">
							...
							<label class="control-label">发件平台名称</label>

							<div class="controls">

								<input name="mail_user_name" type="text" class="span3 m-wrap"  style="height: 35px !important;" value="<?php if($forminfo && $forminfo['mail_user_name']): ?><?php echo $forminfo['mail_user_name']; endif; ?>"/>
								<span style="color:#999999; line-height:40px; margin-left:20px;">可写”XX公司小程序提醒系统“</span>
						...
						<div class="control-group">
							...
							<div class="controls">
								...
								<input name="mail_sendto" type="text" class="span3 m-wrap"  style="height: 35px !important;" value="<?php if($forminfo && $forminfo['mail_sendto']): ?><?php echo $forminfo['mail_sendto']; endif; ?>"/>
								<span style="color:#999999; line-height:40px; margin-left:20px;">多个请用英文,隔开</span>
						...
						<div class="weiz" style="margin-left: 460px;">
