...
<input type="hidden" id="nowhtml" value="navModel" class="navModel5-1">

	<ul class="breadcrumb">
		<li>
			<i class="icon-home"></i>
			拼团基础设置--<?php echo $applet['name']; ?>
		</li>
	</ul>
	...
	<div class="row-fluid">
		<div class="span12">
			...
			<form action="<?php echo Url('Pt/setsave'); ?>?appletid=<?php echo $_GET['appletid']?>" id="form_sample_2" class="form-horizontal" method="post" enctype="multipart/form-data" onsubmit = "return checkinfo();">



				<div class="control-group chongdingy">

					<label class="control-label chongdingywz">拼团基础设置</label>
				...
				<div class="control-group">
					...
					<div class="controls">
						...
						<input type="radio" name="types" value="1" <?php if($pintuan): if($pintuan['types']==1): ?>checked=checked<?php endif; else: ?>checked=checked<?php endif; ?>/>
						...
						<input type="radio" name="types" value="2" <?php if($pintuan): if($pintuan['types']==2): ?>checked=checked<?php endif; endif; ?>/>
						...
						<input type="radio" name="types" value="3" <?php if($pintuan): if($pintuan['types']==3): ?>checked=checked<?php endif; endif; ?>/>
						...
						<input type="radio" name="types" value="4" <?php if($pintuan): if($pintuan['types']==4): ?>checked=checked<?php endif; endif; ?>/>
				...
				<div class="control-group">
					...
					<label class="control-label">自动成团</label>

					<div class="controls">

						<label class="radio">

						<input type="radio" name="is_pt" value="1" <?php if($pintuan): if($pintuan['is_pt']==1): ?>checked=checked<?php endif; else: ?>checked=checked<?php endif; ?>/>
						...
						<input type="radio" name="is_pt" value="2" <?php if($pintuan): if($pintuan['is_pt']==2): ?>checked=checked<?php endif; endif; ?>/>
				...
				<div class="control-group">
					...
					<label class="control-label">拼团时间</label>
					...
					<div class="controls">
						...
						<input name="pt_time" id="pt_time" type="text" class="span1 m-wrap" value="<?php if($pintuan): ?><?php echo $pintuan['pt_time']; else: ?>24<?php endif; ?>" style="height: 35px !important;"><span style="color:#999999; line-height:40px; margin-left:10px;">小时</span>

						<span style="color:#999999; line-height:40px; margin-left:20px;">设置成团的有效时间，默认24小时</span>
				...
				<div class="control-group">
					...
					<label class="control-label">自动收货</label>
					...
					<div class="controls">
						...
						<input name="fahuo" type="text" class="span1 m-wrap" value="<?php if($pintuan['fahuo']): ?><?php echo $pintuan['fahuo']; else: ?>7<?php endif; ?>" style="height: 35px !important;"><span style="color:#999999; line-height:40px; margin-left:10px;">天</span>

						<span style="color:#999999; line-height:40px; margin-left:20px;">设置自动收货时间，默认7天</span>
				...
				<div class="control-group chongdingy">
					...
					<label class="control-label chongdingywz">拼团规则</label>

				</div>
		   
		        <div class="editors" style="margin-left:100px">
			        <script id="editor" name="content" type="text/plain"><?php if($pintuan): ?><?php echo $pintuan['guiz']; endif; ?></script>
			    </div>
				
				<div class="weiz" style="margin-left:100px">
