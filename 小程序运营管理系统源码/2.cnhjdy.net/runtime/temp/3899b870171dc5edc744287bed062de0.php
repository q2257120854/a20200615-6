...
<input type="hidden" id="nowhtml" value="navSystem" class="navSystem5">
		...
		<div class="span12">
			...
			<div class="portlet box ">
				...
				<div class="portlet-body">
					...
					<form action="<?php echo Url('Copyright/save'); ?>?appletid=<?php echo $_GET['appletid']?>" id="form_sample_2" class="form-horizontal" method="post" enctype="multipart/form-data">
						...
						<div class="control-group">
							...
							<div class="controls">
								...
								<input type="radio" name="copy_do" value="0"  <?php if($bases): if($bases['copy_do']=="0"): ?>checked=checked<?php endif; else: ?>checked<?php endif; ?>/>
								...
								<input type="radio" name="copy_do" value="1" <?php if($bases): if($bases['copy_do']=="1"): ?>checked=checked<?php endif; endif; ?>/>
								...
								<span style="color:#999999; line-height:40px; margin-left:20px;">请选择跳转方式</span>
							...
							<div class="controls">
								...
								<div class="fileupload fileupload-new" data-provides="fileupload">
									...
									<div class="fileupload-new thumbnail commonuploadpic" style="width: 140px; height:90px;">
										...
										<?php if($bases && $bases['copyimg']): ?>

										<img src="<?php echo $bases['copyimg']; ?>"/>
									...
									<div>
										...
										<?php if($bases && $bases['copyimg']): ?>
											<span class="btn"  onclick="delimg()">移除</span>
										<?php endif; ?>
									...
									<div class="zphpx"><font color="#999999">不传则不显示 <a href="/upfiles/copyright.png" download="copyright">下载模板</a></font></div>
						...
						<div class="control-group">
							...
							<div class="controls">
								...
								<input name="copyright" type="text" class="span3 m-wrap" value="<?php if($bases): ?><?php echo $bases['copyright']; endif; ?>"  style="height: 35px !important;" />
						...
						<div class="control-group">
							...
							<div class="controls">
								...
								<input name="tel_b" type="text" class="span3 m-wrap" value="<?php if($bases): ?><?php echo $bases['tel_b']; endif; ?>"  style="height: 35px !important;" />
	...
	function delimg(){
		...
		$.ajax({
			url:"<?php echo Url('Copyright/delimg'); ?>",type:"post",dataType:'json',
			data:{
				uniacid:uniacid
			},
