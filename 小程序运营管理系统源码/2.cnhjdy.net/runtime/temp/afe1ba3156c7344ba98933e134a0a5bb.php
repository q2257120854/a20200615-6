<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:81:"/www/wwwroot/2.cnhjdy.net/public/../application/comadmin/view/solution/index.html";i:1575814724;s:78:"/www/wwwroot/2.cnhjdy.net/public/../application/comadmin/view/public/head.html";i:1575814724;s:78:"/www/wwwroot/2.cnhjdy.net/public/../application/comadmin/view/public/left.html";i:1575814724;s:83:"/www/wwwroot/2.cnhjdy.net/public/../application/comadmin/view/public/foot_more.html";i:1575814724;}*/ ?>
<!DOCTYPE html>
...
<input type="hidden" id="nowhtml" value="navSolution" class="navSolution1">
            ...
            <div class="portlet-body">
                ...
                <div class="input-box" style="margin-bottom: 10px; position: relative;">
                    ...
                    <div class="btn-group" style="float:right">
                        ...
                        <a href="<?php echo Url('Solution/add'); ?>" >
                            <button id="sample_editable_1_new" class="btn green">
                                添加解决方案 <i class="icon-plus"></i>
                            </button>
                        </a>
                    ...
                    <tbody>
                        <?php if($list): foreach($list as $v): ?>
                            <tr>
                                ...
                                <td>
                                    <a class="btn" href="<?php echo Url('Solution/add'); ?>?newsid=<?php echo $v['id']; ?>">修改</a>
                                    <a class="btn"  href="<?php echo Url('Solution/del'); ?>?newsid=<?php echo $v['id']; ?>">删除</a>
                                </td>
                            </tr>
