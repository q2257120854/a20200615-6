<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:82:"D:\wwwroot\2.cnhjdy.net\public/../application/comhome\view\functionshow\index.html";i:1575814725;s:74:"D:\wwwroot\2.cnhjdy.net\public/../application/comhome\view\public\top.html";i:1575814725;s:75:"D:\wwwroot\2.cnhjdy.net\public/../application/comhome\view\public\head.html";i:1575814725;s:75:"D:\wwwroot\2.cnhjdy.net\public/../application/comhome\view\public\foot.html";i:1575814725;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <div class="solution_banner">
        ...
        <div class="dynamic_nav">
            ...
            <div class="main2 clearfix">
                ...
                <a class="hover" href="<?php echo Url('Functionshow/index'); ?>">功能展示</a>

                <a href="<?php echo Url('Solution/index'); ?>">行业解决方案</a>
        ...
        <div class="solutionbox">
            ...
            <div class="solution main2">
                ...
                <div class="solution_div clearfix">
                    <?php if($list): foreach($list as $res): ?>

                    <a class="solution_single" href="<?php echo Url('show'); ?>?id=<?php echo $res['id']; ?>" style="background-color: <?php echo $res['listbg']; ?>;">

                        <div class="solution_single_div1 iconfont <?php echo $res['icon']; ?>"></div>

                        <div class="solution_single_div2">

                            <div class="solution_title clearfix">

                                <div class="solution_title_left"><?php echo $res['title']; ?></div>
