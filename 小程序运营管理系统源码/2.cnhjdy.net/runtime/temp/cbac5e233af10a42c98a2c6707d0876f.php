...
<input type="hidden" id="nowhtml" value="navSystem" class="navSystem6">
		...
		<div class="span12">
			...
			<div class="portlet box ">
				...
				<div class="portlet-body">
					...
					<form action="<?php echo Url('Copyright/savecomment'); ?>?appletid=<?php echo $_GET['appletid']?>" id="form_sample_2" class="form-horizontal" method="post" enctype="multipart/form-data" onsubmit = "return checkinfo();">
					    ...
					    <div class="editors">
							<script id="editor" name="copycon" type="text/plain"><?php echo $bases['copycon']; ?></script>
						</div>
    ...
    <script type="text/javascript">
        ...
        function checkinfo(){
    		val = $("#ueditor_textarea_copycon").val();
    		if(!val){
        		alert("请输入内容");
        		return false;
        	}else{
