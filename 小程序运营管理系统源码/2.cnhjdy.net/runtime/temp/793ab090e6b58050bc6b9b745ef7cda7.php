...
<input type="hidden" id="nowhtml" value="navSale" class="navSale6">
	<ul class="breadcrumb">
		<li>
			<i class="icon-home"></i>
			多规格商品设置--<?php echo $applet['name']; ?>
		</li>
	</ul>
	<div class="row-fluid">
		<div class="portlet box">
			<div class="portlet-body form">
				<form action="<?php echo Url('Duoproductsset/save'); ?>?appletid=<?php echo $_GET['appletid']?>" id="form_sample_2" class="form-horizontal" method="post" enctype="multipart/form-data" onsubmit = "return checkinfo();">
	 				<div class="control-group chongdingy">
						<label class="control-label chongdingywz" style="width: 500px">多规格订单表单管理</label>
					</div>
					<div class="control-group">
						...
						<div class="controls">
							<select name="formset" class="span3 m-wrap">
								...
								<?php if($forms): foreach($forms as $v): ?>
									<option value="<?php echo $v['id']; ?>" <?php if($yunfeidata): if($yunfeidata['formset']==$v['id']): ?>selected="selected"<?php endif; endif; ?>><?php echo $v['formname']; ?></option>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input name="yunfei" type="text" class="span2 m-wrap" value="<?php if($yunfeidata): ?><?php echo $yunfeidata['yfei']; endif; ?>"  style="height: 35px !important;" /> 元
							<span style="color:#999999; line-height:40px; margin-left:20px;">设置0则为包邮</span>
						</div>
					</div>
					<div class="control-group">
						<label class="control-label">满额包邮</label>
						<div class="controls">
							<input name="baoyou" type="text" class="span2 m-wrap" value="<?php if($yunfeidata): ?><?php echo $yunfeidata['byou']; endif; ?>"  style="height: 35px !important;" /> 元
							<span style="color:#999999; line-height:40px; margin-left:20px;">单次下单满多少包邮</span>
						</div>
					</div>
					<div class="form-actions" style="overflow: hidden;display: block;">
