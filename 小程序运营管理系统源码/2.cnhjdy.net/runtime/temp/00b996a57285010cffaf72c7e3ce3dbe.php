<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:78:"/www/wwwroot/2.cnhjdy.net/public/../application/comadmin/view/about/index.html";i:1575814724;s:78:"/www/wwwroot/2.cnhjdy.net/public/../application/comadmin/view/public/head.html";i:1575814724;s:78:"/www/wwwroot/2.cnhjdy.net/public/../application/comadmin/view/public/left.html";i:1575814724;s:83:"/www/wwwroot/2.cnhjdy.net/public/../application/comadmin/view/public/foot_more.html";i:1575814724;}*/ ?>
<!DOCTYPE html>
...
<input type="hidden" id="nowhtml" value="navAbout" class="navAbout1">
	...
	<div class="row-fluid">
		...
		<div class="portlet box">
			...
			<div class="portlet-body form">
				...
				<form action="<?php echo Url('About/save'); ?>" id="form_sample_2" class="form-horizontal" method="post" enctype="multipart/form-data">
					<div class="control-group chongdingy">
						<label class="control-label chongdingywz">公司信息</label>
					</div>
					<div class="control-group">
						<label class="control-label">公司介绍</label>
						<div class="controls">
							<script id="descs" name="descs" type="text/plain"><?php if($newsinfo): ?><?php echo $newsinfo['descs']; endif; ?></script>
						</div>
					</div>
					<div class="control-group">
						<label class="control-label">团队介绍</label>
						<div class="controls">
							<script id="teamdesc" name="teamdesc" type="text/plain"><?php if($newsinfo): ?><?php echo $newsinfo['teamdesc']; endif; ?></script>
						</div>
					</div>
