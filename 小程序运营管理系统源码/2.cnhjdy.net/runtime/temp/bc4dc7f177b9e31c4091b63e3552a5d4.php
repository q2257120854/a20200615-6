...
<input type="hidden" id="nowhtml" value="navModel" class="navModel5-3">

	<ul class="breadcrumb">
		<li>
			<i class="icon-home"></i>
			商品管理--<?php echo $applet['name']; ?>
		</li>
	</ul>
			...
			<div class="portlet-body">
				...
				<div class="input-box" style="margin-bottom: 10px; position: relative;">
					...
					<div class="btn-group" style="float:right">
						...
						<a href="<?php echo Url('Pt/proadd'); ?>?appletid=<?php echo $_GET['appletid']?>" >
				...
				<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
					...
					<tbody>
					<?php if($prolist): foreach($prolist as $item): ?>
							<tr>
								<td>
									<?php echo $item['num']; ?>
								</td>
								...
								<td>
									<img src="<?php echo $item['thumb']; ?>" style="width:50px; height:30px;">
								</td>
								<td>
									<?php echo $item['title']; ?>
								</td>
								<td>
									...
									<a href="<?php echo Url('Pt/proadd'); ?>?appletid=<?php echo $_GET['appletid']?>&pid=<?php echo $item['id']; ?>"><button class="btn btncolor">编辑</button></a>
									<form action="<?php echo Url('Pt/prodel'); ?>?appletid=<?php echo $_GET['appletid']?>&pid=<?php echo $item['id']; ?>"  method="post" enctype="multipart/form-data" onsubmit = "return del()">
