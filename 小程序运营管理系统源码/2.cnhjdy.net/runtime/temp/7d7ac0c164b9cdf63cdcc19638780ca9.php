<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:83:"/www/wwwroot/2.cnhjdy.net/public/../application/comadmin/view/functionshow/add.html";i:1575814724;s:78:"/www/wwwroot/2.cnhjdy.net/public/../application/comadmin/view/public/head.html";i:1575814724;s:78:"/www/wwwroot/2.cnhjdy.net/public/../application/comadmin/view/public/left.html";i:1575814724;s:83:"/www/wwwroot/2.cnhjdy.net/public/../application/comadmin/view/public/foot_more.html";i:1575814724;}*/ ?>
<!DOCTYPE html>
...
<style>
	...
	<div class="row-fluid">
		...
		<div class="portlet box">
			...
			<div class="portlet-body form">
				...
				<form action="<?php echo Url('Functionshow/save'); ?>?newsid=<?php echo $newsid; ?>" id="form_sample_2" class="form-horizontal" method="post" enctype="multipart/form-data" onsubmit = "return checkinfo();">
					...
					<div class="control-group chongdingy">
						...
						<label class="control-label chongdingywz">功能展示管理</label>
					...
					<div class="control-group">
						...
						<div class="controls">
							...
							<input type="radio" name="recommend" value="2" <?php if($newsinfo): if($newsinfo['recommend']==2): ?>checked=checked<?php endif; endif; ?>/>
							...
							<input type="radio" name="recommend" value="1" <?php if($newsinfo): if($newsinfo['recommend']==1): ?>checked=checked<?php endif; endif; ?>/>
							...
							<span style="color:#999999; line-height:40px; margin-left:20px;">推荐后会在首页显示</span>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input name="hits" type="text" class="span1 m-wrap" value="<?php if($newsinfo): ?><?php echo $newsinfo['hits']; endif; ?>"  style="height: 35px !important;" />
					...
					<div class="control-group">
						...
						<div class="controls">
							<input name="title" type="text" class="span5 m-wrap" value="<?php if($newsinfo): ?><?php echo $newsinfo['title']; endif; ?>"  style="height: 35px !important;" />
					...
					<div class="control-group">
						...
						<div class="controls">
							<input name="icon" type="text" class="span2 m-wrap" value="<?php if($newsinfo): ?><?php echo $newsinfo['icon']; endif; ?>"  style="height: 35px !important;" />
							<span style="color:#999999; line-height:40px; margin-left:20px;"></span>
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<textarea class="span3 m-wrap" style="height:150px;" name="descs"><?php if($newsinfo): ?><?php echo $newsinfo['descs']; endif; ?></textarea>
						</div>
					</div>
					<div class="control-group">
						<label class="control-label">列表背景颜色</label>
						<div class="controls">
							<input name="listbg" type="text" class="span2 m-wrap" value="<?php if($newsinfo): ?><?php echo $newsinfo['listbg']; endif; ?>"  style="height: 35px !important;" />
					...
					<div class="control-group" style="margin-bottom:0px !important;">
						...
						<label class="control-label">功能展示图</label>
						...
						<div class="controls">
							...
							<span style="color:#999999; line-height:40px; margin-left:20px;">图片大小为260*459</span>
					...
					<div class="control-group " style="padding-top:10px">
						...
						<div class="controls commonuploadslide" id="imgzs" style="font-size:0">
							...
							<?php if($newsinfo): if($newsinfo['funcimg']): foreach($newsinfo['funcimg'] as $k => $res): ?>

								<div class="paiwei " onmousemove="xians(this)" onmouseout="gb(this)" id="li<?php echo $k; ?>">
		                            <img src="<?php echo $res; ?>" style="width: 140px; height:90px;">
		                            <div class="beijingys">
		                            </div>
		                            <div class="sancann" onclick="del(<?php echo $k; ?>)">
		                                <span class="cancel">删除</span>
		                            </div>
		                            <input type="hidden" name="imgsrcs[]" value="<?php echo $res; ?>">
		                        </div>
					...
					<div class="control-group">
						...
						<div class="controls">						
							<div class="editors">
								<script id="editor" name="text" type="text/plain"><?php if($newsinfo): ?><?php echo $newsinfo['text']; endif; ?></script>
						    </div>
						</div>
					</div>
					<div class="control-group">
						<label class="control-label">使用场合</label>
						<div class="controls">
							<input name="place" type="text" class="span5 m-wrap" value="<?php if($newsinfo): ?><?php echo $newsinfo['place']; endif; ?>"  style="height: 35px !important;" />
							<span style="color:#999999; line-height:40px; margin-left:20px;">多个标签请使用,或空格分隔</span>
						</div>
					</div>
					<div class="control-group">
						<label class="control-label">功能展示</label>
						<div class="controls">
							<input name="func" type="text" class="span5 m-wrap" value="<?php if($newsinfo): ?><?php echo $newsinfo['func']; endif; ?>"  style="height: 35px !important;" />
							<span style="color:#999999; line-height:40px; margin-left:20px;">多个请用，分开</span>
						</div>
					</div>
    ...
    function catecheck(me){
        ...
        if(id !=0){
            $.ajax({
        		url:"<?php echo Url('Pictures/getcates'); ?>",type:"post",dataType:'json',
        		data:{
        			id:id
