...
<input type="hidden" id="nowhtml" value="navModel" class="navModel5-5">
<ul class="breadcrumb">
    <li>
        <i class="icon-home"></i>
        成团管理--<?php echo $applet['name']; ?>
    </li>
</ul>
...
<!--                 <div class="control-group chongdingy">
                    ...
                    <label class="control-label chongdingywz">成团管理</label>
    ...
    <?php foreach($plist as $item): ?>
        ...
        <td colspan="1" style="text-align:center;font-size:12px;border-right:1px solid #dedede" class="aops">
            状态                       
        </td>
    ...
    <tr class="trbody">
        ...
        <td style="overflow:hidden;border-left:1px solid #dedede;" >
            <img src="<?php echo $item['pro']['thumb']; ?>" style="width:50px;height:50px;border:1px solid #ccc; padding:1px;" onerror="">
        </td>

        <td style="text-align: left;overflow:hidden;border-left:none;"> 
            <?php if(isset($item['pro']['title'])): ?><?php echo $item['pro']['title']; endif; ?>
        </td>

        <td style="text-align:center;border-left:none;">
           <?php if(isset($item['pro']['pt_max'])): if(isset($item['pro']['pt_min'])): ?>
            <?php echo $item['join_count']; ?>/<?php echo $item['pt_min']; ?>-<?php echo $item['pt_max']; endif; endif; ?>
        </td>

        <td style="text-align:center;border-left:none;" >
            <?php echo $item['creattime']; ?>
        </td>

        <td style="text-align:center;border-left:none;" >
            <?php echo $item['overtime']; ?>
        </td>

        <td style="text-align:center;border-left:none;border-right:1px solid #dedede;" >
            <?php if($item['flag']==1): ?>
                进行中
            <?php endif; if($item['flag']==2||$item['flag']==4): ?>
                已成团
            <?php endif; if($item['flag']==3): ?>
                已失败
            <?php endif; ?>
            <a class="btn btn-success" style="background:#0d638f;color:#fff" href="<?php echo Url('Pt/order'); ?>?appletid=<?php echo $_GET['appletid']?>&ptorder=<?php echo $item['shareid']; ?>">拼团订单></a>
        </td>
    ...
    <tr style="border-bottom:none;background:#f9f9f9;">
        <td colspan="6" style="border-left:1px solid #dedede;text-align:center;border-right:1px solid #dedede;">
            参与的成员
        </td>
    </tr>
    
    <tr style="border-bottom:1px solid #dedede;background:#f9f9f9;border-right:1px solid #dedede;">
        <td colspan="6" style="text-align:left;border-left:1px solid #dedede;">
            <?php foreach($item['team'] as $tlist): ?>
                <img src="<?php echo $tlist['team']['avatar']; ?>" style="width:50px; height:50px;">
            <?php endforeach; ?>
        </td>
    </tr>
