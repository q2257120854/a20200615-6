<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:74:"/www/wwwroot/2.cnhjdy.net/public/../application/comadmin/view/news/gg.html";i:1575814724;s:78:"/www/wwwroot/2.cnhjdy.net/public/../application/comadmin/view/public/head.html";i:1575814724;s:78:"/www/wwwroot/2.cnhjdy.net/public/../application/comadmin/view/public/left.html";i:1575814724;s:83:"/www/wwwroot/2.cnhjdy.net/public/../application/comadmin/view/public/foot_more.html";i:1575814724;}*/ ?>
<!DOCTYPE html>
...
<input type="hidden" id="nowhtml" value="navNews" class="navNews2">
<ul class="breadcrumb">
    <li>
        <i class="icon-home"></i>
        公司公告管理
            ...
            <div class="portlet-body">
                ...
                <div class="input-box" style="margin-bottom: 10px; position: relative;">
                    ...
                    <div class="btn-group" style="float:right">
                        ...
                        <a href="<?php echo Url('News/addgg'); ?>" >
                            <button id="sample_editable_1_new" class="btn green">
                                添加公司公告 <i class="icon-plus"></i>
                            </button>
                        </a>
                    ...
                    <tbody>
                        <?php if($list): foreach($list as $v): ?>
                            <tr>
                                ...
                                <td>
                                    <a class="btn" href="<?php echo Url('news/addgg'); ?>?newsid=<?php echo $v['id']; ?>">修改</a>
