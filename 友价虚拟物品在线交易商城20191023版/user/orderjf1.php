...
$sj=date("Y-m-d H:i:s");
while0("*","yjcode_order where orderbh='".$orderbh."' and (ddzt='jf' or ddzt='jfbuy' or ddzt='jfsell') and userid=".$userid);if(!$row=mysql_fetch_array($res)){php_toheader("order.php");}
