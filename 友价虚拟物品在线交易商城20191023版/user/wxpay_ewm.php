...
<div class="userright">
 ...
 <ul class="wz">
 <li class="l1 l2"><a href="wxpay_ewm.php">扫码支付</a></li>
 </ul>

 <!--白B-->
 <div class="rkuang">
 
 <? systs("恭喜您，操作成功，<strong>我们将尽快核实入账</strong>，请稍等!","wxpay_ewm.php")?>
 <ul class="uk1">
 <li class="l1"></li>
 ...
 <ul class="uk">
 <li class="l1">操作提示：</li>
 <li class="l21">请打开手机<span class="red">微信</span>，扫描以上二维码充值转账，如有疑问，请咨询右侧客服QQ</li>
 <li class="l1">充值金额：</li>
 <li class="l2"><input type="text" class="inp" name="t1" value="<?=$money1?>" /> <span class="red fd">请务必与实际充值金额保持一致</span></li>
 <li class="l1">微信订单号：</li>
 <li class="l2"><input type="text" class="inp" name="t2" /> <span class="red fd">请输入扫码支付成功后的微信订单号</span></li>
