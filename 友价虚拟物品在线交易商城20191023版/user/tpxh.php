...
if($_GET[control]=="xh"){
 ...
 for($i=1;$i<$xhall;$i++){
  ...
  updatetable("yjcode_tp","xh=".$xh." where userid=".$userid." and id=".$xhid);
 }
...
<div class="tplist">
 ...
 <?
 $i=1;
 while1("*","yjcode_tp where bh='".$bh."' and userid=".$userid." order by xh asc");while($row1=mysql_fetch_array($res1)){
 if(empty($row1[upty])){
  $tp1="../".$row1[tp];
