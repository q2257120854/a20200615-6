...
while1("*","yjcode_dingdang where ddbh='".$out_trade_no."' and ddzt='等待买家付款'");if($row1=mysql_fetch_array($res1)){
 updatetable("yjcode_dingdang","sj='".$sj."',uip='".$uip."',ifok=1,alipayzt='TRADE_SUCCESS',ddzt='交易成功' where id=".$row1[id]);
 $money1=$row1["money1"];
 PointIntoM($row1[userid],"财付通充值".$money1."元",$money1);
...
php_toheader(weburl."user/order.php");
?>