...
$user = $codepay_config['user'];  //这是默认的用户名 安装的演示充值只有admin 如正式使用直接删除
            ...
            <article class="clearfix mt10 m-round g-pay-ment g-bank-ct">
                <ul id="ulBankList">
                    <li class="gray6" style="width: 100%;padding: 5px 0px 0px 10px;height: 50px;">您选择充值：<label class="input" style="border: 1px solid #EAEAEA;height: 35px;font-size:30px;">
                            <input type="text" name="price" id="price" placeholder="如：50" value="50" style="width: 170px;color: red;font-size:20px;">   <!--默认输入金额值50-->
                        </label> 元
                    </li>
                    <li class="gray6" style="width: 100%;padding: 5px 0px 0px 10px;display: inline;height: 50px;">充值用户名：<label class="input" style="border: 1px solid #EAEAEA;height: 30px;font-size: 30px;">
                            <input type="text" name="user" id="user" placeholder="用户名" value="<?php echo $user?>" style="width: 180px;font-size: 16px;">
                        </label></li>
