...
<div class="right">
 ...
 <?
 $adbh=array("ADDL","ADLP","ADI00","ADI01","ADI02","ppt_qh","ADI05","ADI13","ADI14","ADTOP","ppt_01","ppt_02","ppt_03","ppt_04","ppt_05","ppt_06","ADKF","ppt_07");
 $adtit=array("对联广告","首页拉屏广告","首页顶部广告","底部广告","导航菜单","首页切换图片","顶部搜索框右方广告","首页底部合作伙伴","首页底部友情链接","全站顶部广告","首页商品列表左侧上方广告","首页商品列表左侧下方广告","热门商品下方横幅","首页资讯区切换","首页资讯区右侧广告","切换下方小图","右侧自定义客服","快捷菜单左侧小图标");
 $adsize=array("100*?","1150*?","1150*?","1150*?","","1920*300","250*75","100*35","","1150*?","220*420","220*160","1150*?","425*226","290*175","310*125","","18*17","");
 $admust=array("pic","pic","pic","","font","pic","","pic","font","","","","","pic","","","code","pic");
