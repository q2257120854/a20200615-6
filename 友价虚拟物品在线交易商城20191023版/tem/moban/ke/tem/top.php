 ...
 <div class="top">
  ...
  <li class="l1">
   <span id="notlogin" style="display:none">
    <span class="s1">
    您好，欢迎来<?=webname?>！[<a href="<?=weburl?>reg/">登录</a> | <a href="<?=weburl?>reg/reg.php">免费注册</a><? if($rowcontrol[wxlogin]!="" && $rowcontrol[wxlogin]!=","){?> | <a href="https://open.weixin.qq.com/connect/qrconnect?appid=<?=$wxlogin[0]?>&redirect_uri=<?=urlencode(weburl."reg/wxlogin.php")?>&response_type=code&scope=snsapi_login#wechat_redirect" target="_blank">微信登录</a><? }?> | <a href="<?=weburl?>config/qq/oauth/index.php">QQ登录</a>]</span>
   </span>
