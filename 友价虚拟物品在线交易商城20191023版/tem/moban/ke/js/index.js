...
function updatePageidl() {
 if (xmlHttpidl.readyState == 4) {
  ...
  userCheckses();
    ...
    document.querySelector('#idlno .u1 li.mylogin').style.display='none';
    
    document.querySelector('#idlno .u1 li.myuser').style.display='block'
    document.querySelector('#idlno .u1 .l1').innerHTML = '你好 ! '+a[1]
    document.getElementById("idltx1").innerHTML=a[6];
