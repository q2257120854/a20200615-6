...
function iksaover(x){
for(i=1;i<=3;i++){
document.getElementById("iksa"+i).className="l1";
document.getElementById("ksm"+i).style.display="none";
}
document.getElementById("iksa"+x).className="l1 l11";
document.getElementById("ksm"+x).style.display="";
}
//快速登录E