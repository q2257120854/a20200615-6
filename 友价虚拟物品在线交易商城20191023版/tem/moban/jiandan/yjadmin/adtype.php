...
<div class="right">
 ...
 <?
 $adbh=array("ADDL","ADLP","ADI00","ADI01","ADI02","jiandan_01","ADI13","ADI14","ADTOP","ADKF");
 $adtit=array("对联广告","首页拉屏广告","首页顶部广告","底部广告","导航菜单","首页切换图片","首页底部合作伙伴","首页底部友情链接","全站顶部广告","右侧自定义客服");
 $adsize=array("100*?","1150*?","1150*?","1150*?","","1920*300","100*35","","1150*?","");
