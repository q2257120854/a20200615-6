...
<div class="right">
 ...
 <?
 $adbh=array("ADDL","ADLP","ADI00","ADI01","ADI02","shang_01","ADI05","ADI13","ADI14","ADTOP","shang_02","shang_03","blue_01","ADKF");
 $adtit=array("对联广告","首页拉屏广告","首页顶部广告","底部广告","导航菜单","首页切换图片","顶部搜索框右方广告","首页底部合作伙伴","首页底部友情链接","全站顶部广告","首页商品列表左下广告","首页统计左侧广告","首页交易流程右侧广告","右侧自定义客服");
 $adsize=array("100*?","1150*?","1150*?","1150*?","","1920*350","250*75","100*35","","1150*?","240*235","220*140","130*260","");
