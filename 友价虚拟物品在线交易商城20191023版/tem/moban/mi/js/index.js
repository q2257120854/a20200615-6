//商品切换
function listcapover(x){
a=document.getElementById("listcapA").innerHTML;
for(i=1;i<a;i++){
 document.getElementById("lista"+i).className="";
 document.getElementById("list"+i).style.display="none";
}
 document.getElementById("lista"+x).className="a1";
 document.getElementById("list"+x).style.display="";
}
