...
<div class="right">
 ...
 <li class="l3">管理</li>
  ...
  <?
 $adbh=array("ADDL","ADLP","ADI00","ADI01","ADI02","shun_qh","ADI05","ADI13","ADI14","ADTOP","shun_01","shun_02","shun_03","shun_06","ADKF");
 $adtit=array("对联广告","首页拉屏广告","首页顶部广告","底部广告","导航菜单","首页切换图片","顶部搜索框右方广告","首页底部合作伙伴","首页底部友情链接","全站顶部广告","首页商品列表左侧上方广告","首页商品列表左侧下方广告","热门商品下方横幅","切换下方小图","右侧自定义客服");
 $adsize=array("100*?","1150*?","1150*?","1150*?","","1920*300","250*75","100*35","","1150*?","220*420","220*160","1150*?","310*125","");
