...
function ssycapover(x){
for(i=1;i<=3;i++){
 document.getElementById("syycap"+i).className="l1";
 document.getElementById("ssym"+i).style.display="none";
}
 document.getElementById("syycap"+x).className="l1 l11";
 document.getElementById("ssym"+x).style.display="";
}
