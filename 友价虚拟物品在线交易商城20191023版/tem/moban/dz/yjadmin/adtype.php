...
<div class="right">
 ...
 <?
 $adbh=array("ADDL","ADLP","ADI00","ADI01","ADI02","928vip_qh","ADI05","ADI13","ADI14","ADTOP","928vip_01","928vip_02","928vip_03","928vip_04","928vip_05","928vip_06");
 $adtit=array("对联广告","首页拉屏广告","首页顶部广告","底部广告","导航菜单","首页切换图片","顶部搜索框右方广告","首页底部合作伙伴","首页底部友情链接","全站顶部广告","首页商品列表左侧上方广告","首页商品列表左侧下方广告","热门商品下方横幅","首页资讯区切换","首页资讯区右侧广告","快捷菜单左侧小图标");
 $adsize=array("100*?","1150*?","1150*?","1150*?","","1920*424","250*75","150*52","","1150*?","220*420","220*160","1150*?","425*226","290*175","19*19");
