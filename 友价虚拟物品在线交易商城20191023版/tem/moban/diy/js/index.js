...
//列表切换B
function icapover(x,y){
document.getElementById("icap"+x+"_1").className="l1";
document.getElementById("icap"+x+"_2").className="l1";
document.getElementById("icap"+x+"_"+y).className="l1 l11";
document.getElementById("ilist"+x+"_1").style.display="none";
document.getElementById("ilist"+x+"_2").style.display="none";
document.getElementById("ilist"+x+"_"+y).style.display="";
}
//列表切换E