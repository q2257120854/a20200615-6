...
<div class="right">
 ...
 <?
 $adbh=array("ADDL","ADLP","ADI00","ADI01","ADI02","DIY_qh","ADI05","ADI13","ADI14","ADTOP","DIY_01","DIY_02","DIY_03","DIY_04","DIY_05","DIY_06","ADKF");
 $adtit=array("对联广告","首页拉屏广告","首页顶部广告","底部广告","导航菜单","首页切换图片","顶部搜索框右方广告","首页底部合作伙伴","首页底部友情链接","全站顶部广告","方便后期增加使用首页商品列表左侧上方广告","方便后期增加使用首页商品列表左侧下方广告","活动商品上方横幅","活动商品下方横幅","友情连接上方横幅","切换下方小图","右侧自定义客服");
 $adsize=array("100*?","1150*?","1150*?","1150*?","","1920*300","250*75","100*35","","1150*?","220*420","220*160","1150*?","1150*?","1150*?","20*20","");
