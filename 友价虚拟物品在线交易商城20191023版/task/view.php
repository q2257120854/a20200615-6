...
<div class="yjcode">
 ...
 <div class="lxinf">
  ...
  ?>
  <div class="d3"><a href=<? if($qqxs==1){?>"http://wpa.qq.com/msgrd?v=3&uin=<?=$rowuser[uqq]?>&site=<?=weburl?>&menu=yes"<? }else{?>"javascript:void(0);" onClick="alert('<?=$qqxsvalue?>');"<? }?>>QQ联系TA</a></div>
  <div class="d4">
   <? if(1==$qqxs){?>
