...
<div class="right">
 ...
 <div class="bqu1">
 <a class="a1" href="tasktypelist.php">任务分组</a>
 </div>
 ...
 <a class="add" href="tasktype1.php?ty1id=<?=$row1[id]?>">添加子类</a><span></span>
 ...
 $nu="tasktype1.php?action=update&id=".$row2[id]."&ty1id=".$row1[id]; 
 ?>
 <ul class="qjlist2">
