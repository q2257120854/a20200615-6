...
<div class="right">
 ...
 <script language="javascript">document.getElementById("rtit0").className="a1";</script>
 ...
 <?
 $adbh=array("ADDL","ADLP","ADI00","ADI01","ADI02","ADI13","ADI14","ADTOP","ADKF");
 $adtit=array("对联广告","首页拉屏广告","首页顶部广告","底部广告","导航菜单","首页底部合作伙伴","首页底部友情链接","全站顶部广告","右侧自定义客服");
 $adsize=array("100*?","1150*400","1150*?","1150*?","","100*35","","1150*?","");
