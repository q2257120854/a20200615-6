...
<div class="right">
 <div class="bqu1">
 <a class="a1" href="tuisong.php?ddzt=<?=$_GET[ddzt]?>"><?=returnjgdw(returnorderzt($_GET[ddzt]),"","百度推送记录")?></a>
 </div>
 <ul class="ordercap">
 ...
 <?
 pagef($ses,10,"baiduurl","order by id desc");while($row=mysql_fetch_array($res)){
     //print_r($row);
