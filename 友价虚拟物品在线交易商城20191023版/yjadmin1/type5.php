...
if($_GET[control]=="add"){
 ...
 updatetable("yjcode_type","sj='".$sj."',xh=".sqlzhuru($_POST[t2]).",type5='".sqlzhuru($_POST[t1])."' where id=".$_GET[id]);
...
<div class="right">
 ...
 <li class="l1">排序：</li>
 <li class="l2"><input type="text" class="inp" name="t2" value="<?=returnxh("yjcode_type"," and type1='".$ty1name."' and type2='".$ty2name."' and type3='".$ty3name."' and type4='".$ty4name."' and admin=5")?>" /> <span class="fd">序号越小，越靠前</span></li>
