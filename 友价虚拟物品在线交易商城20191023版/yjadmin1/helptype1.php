...
if($_GET[control]=="add"){
 ...
 zwzr();
 if(panduan("*","yjcode_helptype where admin=2 and name1='".sqlzhuru($_POST[t0])."' and name2='".sqlzhuru($_POST[t1])."'")==1){Audit_alert("该帮助中心分类已存在！","helptype1.php?ty1id=".$_GET[ty1id]);}
 ...
 if(!strstr($adminqx,",0,") && !strstr($adminqx,",0301,")){Audit_alert("权限不够","default.php");}
 zwzr();
 if(panduan("*","yjcode_helptype where admin=2 and name1='".sqlzhuru($_POST[t0])."' and name2='".sqlzhuru($_POST[t1])."' and id<>".$_GET[id])==1){Audit_alert("该帮助中心分类已存在！","helptype1.php?action=update&id=".$_GET[id]."&ty1id=".$_GET[ty1id]);}
...
<div class="right">
 ...
 <div class="bqu1">
 <a href="javascript:void(0);" class="a1">编辑二级帮助中心分类</a>
 ...
 <li class="l1">排序：</li>
 <li class="l2"><input type="text" class="inp" name="t2" value="<?=returnxh("yjcode_helptype"," and admin=2 and name1='".$row[name1]."'")?>" /> <span class="fd">序号越小，越靠前</span></li>
