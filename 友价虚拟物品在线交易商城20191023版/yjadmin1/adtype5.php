...
<div class="right">
 ...
 <?
 $adbh=array("ADMT01","ADMT02","ADMT03","ADMT04","ADMT05");
 $adtit=array("手机端首页切换图片","手机版首页商品类别上方横幅","手机版首页列表展示广告","手机端导航菜单","手机端商品详情上方广告");
 $adsize=array("640*300","640*?","640*?","45*45","640*?");
