...
?>
<div class="indexcap box">
 <div class="dpro" style="border-left:<?=$row[col]?> solid 3px;color:<?=$row[col]?>;"><?=$row[type1]?></div>
 <div class="dmore" onClick="gourl('product/search_j<?=$row[id]?>v.html')"> 更多>></div>
</div>
...
<div class="indexzx box" onClick="gourl('news/txtlist_i<?=$row[id]?>.html')">
 <div class="d1"><img src="<?=returntp("bh='".$row[bh]."' order by xh asc","-1")?>" onerror="this.src='../../img/none180x180.gif'" width="100" height="75" /></div>
