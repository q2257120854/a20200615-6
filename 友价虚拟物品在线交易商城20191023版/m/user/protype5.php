...
<option value="0">选择五级分类(可留空)</option>
<? while2("*","yjcode_type where admin=5 and type1='".$type1name."' and type2='".$type2name."' and type3='".$type3name."' and type4='".$type4name."' order by xh asc");while($row2=mysql_fetch_array($res2)){?>
