...
if(sqlzhuru($_POST[jvs])=="carpay"){
	...
	intotable("yjcode_dingdang","bh,ddbh,userid,sj,uip,money1,ddzt,alipayzt,bz,ifok,wxddbh,carid","'".$bh."','".$ddbh."',".$rowuser[id].",'".$sj."','".$uip."',".$money1.",'等待买家付款','','微信手机支付',0,'".$_SESSION[wxddbh]."','".$caridarr."'");
}
...
WxPayConfig::set_key( $payment['wxpay_jspay_key'] );
	...
	if ( empty($_SESSION['wxpay_jspay_openid'])  ){
		...
		$notify_url = $root_url.'m/user/wxpay/wxpay_jspay_notify.php';
