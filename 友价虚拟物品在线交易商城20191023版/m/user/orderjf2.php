...
if(sqlzhuru($_POST[jvs])=="jf"){
 ...
 if(empty($txt)){Audit_alert("申请理由内容不得为空，返回重试！","orderjf2.php?orderbh=".$orderbh);}
...
<div class="bfbtop1 box">
 <div class="d1" onClick="gourl('sellorderview.php?orderbh=<?=$orderbh?>')"><img src="img/topleft.png" height="21" /></div>
 <div class="d2">纠纷处理沟通记录</div>
 <div class="d3"></div>
</div>
