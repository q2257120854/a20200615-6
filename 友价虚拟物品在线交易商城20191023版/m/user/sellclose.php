...
if(sqlzhuru($_POST[jvs])=="close"){
 ...
 if(panduan("uid,zfmm","yjcode_user where pwd='".$zfmm."' and uid='".$_SESSION[SHOPUSER]."'")==0){Audit_alert("登录密码有误！","sellclose.php?orderbh=".$orderbh);}
 ...
 updatetable("yjcode_order","ddzt='close' where selluserid=".$userid." and id=".$row[id]);
