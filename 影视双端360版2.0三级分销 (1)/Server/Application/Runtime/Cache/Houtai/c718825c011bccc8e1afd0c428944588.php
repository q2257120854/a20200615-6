...
<div class="page-content clearfix">
 <div class="search_style">
     <form action="/Houtai/Kami/daotxt" method="POST">
 ...
 <div class="sort_style">
     <div class="border clearfix">
       <span class="l_f">
        <a href="/Houtai/Kami/add" id="sort_add" class="btn btn-warning"><i class="fa fa-plus"></i> 添加卡密</a>
		
		<a href="/Houtai/Kami/txt" id="sort_add" class="btn btn-warning" style="background-color:#7EC0EE!important;border-color: #7EC0EE;"><i class="fa fa-plus"></i>导出全部到TXT</a>
