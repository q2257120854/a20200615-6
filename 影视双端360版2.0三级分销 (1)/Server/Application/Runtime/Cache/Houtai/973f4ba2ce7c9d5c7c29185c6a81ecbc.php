...
<div class="sort_style">
     <div class="border clearfix">
       <span class="l_f">
        <a  href="javascript:ovid()" onclick="shenhe()"id="sort_add" class="btn btn-warning"><i class="fa fa-plus"></i> 批量审核</a>
  ...
  <div class="sort_list">
	...
	<tbody>
      ...
      <td><a href="#"><?php echo ($vo["uname"]); ?></a></td>                              
		<td><?php echo ($vo["price"]); ?></td>
		<td ><?php echo ($vo["zhifubao"]); ?></td>
		<td ><?php echo (date("Y-m-d H:i:s",$vo["addtime"])); ?></td>
		 <td ><?php echo ($vo["beizhu"]); ?></td> 
		
       <td class="td-status">
	   
	   <?php if($vo["status"] == 1 ): ?><span class="label label-success radius">待审核</span>
	   
	   <?php else: ?>
	   <span class="label label-success radius">审核通过</span><?php endif; ?>
	   </td>
      <td class="td-manage">
...
function shenhe(){
		...
		var ids = '';
			...
			if (Checkbox){
				...
				var t=confirm("您是否审核通过这些数据？");
				if (t==false) return false;	
						
						$.ajax({
							url:"/Houtai/Tixian/shenhe",	//请求地址
							type:"get",		//请求方式
							data:{id:ids},//发送数据
							async:true,			//异步情趣
							dataType:"text",	//响应数据格式
