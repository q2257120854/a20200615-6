...
<div class=" clearfix" id="advertising">
   ...
   <div class="border clearfix">
       <span class="l_f">
        <a href="/Houtai/Type/add" id="ads_add" class="btn btn-warning"><i class="fa fa-plus"></i> 添加分类</a>
	...
	<tbody>
	 <?php if(is_array($mod)): $i = 0; $__LIST__ = $mod;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
       ...
       <td><span class="ad_img"><img src="<?php echo ($vo["picname"]); ?>"  width="30%" height="100%"/></span></td>
	
       
       
      <td class="td-manage">
        
        <a title="编辑"  href="/Houtai/Type/edit?id=<?php echo ($vo["id"]); ?>"  class="btn btn-xs btn-info" ><i class="fa fa-edit bigger-120"></i></a>      
        <a title="删除" href="/Houtai/Type/del?id=<?php echo ($vo["id"]); ?>"   class="btn btn-xs btn-warning" ><i class="fa fa-trash  bigger-120"></i></a>
       </td>
